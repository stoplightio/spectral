...
describe('bundleAndLoadRuleset browser', () => {
  ...
  beforeEach(() => {
    ...
    serveAssets({
      'https://esm.sh/lodash.lowercase': `export * from '/-/lodash.lowercase@v4.3.0-wnZEyQC0Ez8mSkImRcvK/dist=es2020,mode=imports/optimized/lodash.lowercase.js';
...
export {default} from '/-/lodash.uppercase@v4.3.0-Ghj8UDzvgbRFVHwnUM53/dist=es2020,mode=imports/optimized/lodash.uppercase.js';`,
      ...
      'https://esm.sh/-/lodash.lowercase@v4.3.0-wnZEyQC0Ez8mSkImRcvK/dist=es2020,mode=imports/optimized/lodash.lowercase.js':
