...
describe('Ruleset Bundler', () => {
  ...
  describe('given runtime target', () => {
    it('should output an iife', async () => {
      serveAssets({
        'https://esm.run/lodash.lowercase': `export * from '/-/lodash.lowercase@v4.3.0-wnZEyQC0Ez8mSkImRcvK/dist=es2020,mode=imports/optimized/lodash.lowercase.js';
export {default} from '/-/lodash.lowercase@v4.3.0-wnZEyQC0Ez8mSkImRcvK/dist=es2020,mode=imports/optimized/lodash.lowercase.js';`,
        'https://esm.run/lodash.uppercase': `export * from '/-/lodash.uppercase@v4.3.0-Ghj8UDzvgbRFVHwnUM53/dist=es2020,mode=imports/optimized/lodash.uppercase.js';
export {default} from '/-/lodash.uppercase@v4.3.0-Ghj8UDzvgbRFVHwnUM53/dist=es2020,mode=imports/optimized/lodash.uppercase.js';`,

        'https://esm.run/-/lodash.lowercase@v4.3.0-wnZEyQC0Ez8mSkImRcvK/dist=es2020,mode=imports/optimized/lodash.lowercase.js':
        ...
        'https://esm.run/-/lodash.uppercase@v4.3.0-Ghj8UDzvgbRFVHwnUM53/dist=es2020,mode=imports/optimized/lodash.uppercase.js':
...
export default (input) => {
  if (upperCase(input) !== input) {
    return [{ message: 'must be upper case' }];
        ...
        '/p/.spectral/lower-case.mjs': `import lowerCase from 'https://esm.run/lodash.lowercase';
...
export default {
  rules: {
    ...
    'lower-case-rule': {
      ...
      expect(code).toEqual(`import lowerCase$1 from 'https://esm.run/lodash.lowercase';
import upperCase$1 from 'https://esm.run/lodash.uppercase';
...
export {default} from '/-/lodash.uppercase@v4.3.0-Ghj8UDzvgbRFVHwnUM53/dist=es2020,mode=imports/optimized/lodash.uppercase.js';`,
        ...
        '/p/.spectral/upper-case.mjs': `import upperCase from 'https://esm.run/lodash.uppercase';
...
export default {
  rules: {
    ...
    expect(Object.keys(bundle.modules).sort()).toStrictEqual([
      ...
      '/p/spectral.mjs',
      'https://esm.run/-/lodash.uppercase@v4.3.0-Ghj8UDzvgbRFVHwnUM53/dist=es2020,mode=imports/optimized/lodash.uppercase.js',
      'https://esm.run/lodash.uppercase',
    ]);
  });
});
