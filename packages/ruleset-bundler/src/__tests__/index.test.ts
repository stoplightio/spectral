...
describe('Ruleset Bundler', () => {
  ...
  describe('given runtime target', () => {
    it('should output an iife', async () => {
      serveAssets({
        'https://cdn.jsdelivr.net/npm/lodash.lowercase/+esm': `export * from '/-/lodash.lowercase@v4.3.0-wnZEyQC0Ez8mSkImRcvK/dist=es2020,mode=imports/optimized/lodash.lowercase.js';
...
export {default} from '/-/lodash.uppercase@v4.3.0-Ghj8UDzvgbRFVHwnUM53/dist=es2020,mode=imports/optimized/lodash.uppercase.js';`,
        ...
        'https://cdn.jsdelivr.net/-/lodash.lowercase@v4.3.0-wnZEyQC0Ez8mSkImRcvK/dist=es2020,mode=imports/optimized/lodash.lowercase.js':
        ...
        'https://cdn.jsdelivr.net/-/lodash.uppercase@v4.3.0-Ghj8UDzvgbRFVHwnUM53/dist=es2020,mode=imports/optimized/lodash.uppercase.js':
...
export default (input) => {
  if (upperCase(input) !== input) {
    return [{ message: 'must be upper case' }];
        ...
        '/p/.spectral/lower-case.mjs': `import lowerCase from 'https://cdn.jsdelivr.net/npm/lodash.lowercase/+esm';
...
export default {
  rules: {
    ...
    'lower-case-rule': {
      ...
      expect(code).toEqual(`import lowerCase$1 from 'https://cdn.jsdelivr.net/npm/lodash.lowercase/+esm';
import upperCase$1 from 'https://cdn.jsdelivr.net/npm/lodash.uppercase/+esm';
...
export {default} from '/-/lodash.uppercase@v4.3.0-Ghj8UDzvgbRFVHwnUM53/dist=es2020,mode=imports/optimized/lodash.uppercase.js';`,
        ...
        '/p/.spectral/upper-case.mjs': `import upperCase from 'https://cdn.jsdelivr.net/npm/lodash.uppercase/+esm';
