    ...
    test('validate security definitions', async () => {
      expect(
      ...
      ).toEqual([
        {
          ...
          resolvedPath: ['securityDefinitions', 'basic'],
    ...
    test('validate parameters', async () => {
      expect(
      ...
      ).toEqual([
        {
          ...
          resolvedPath: ['paths', '/user', 'get', 'parameters', '0', 'schema', 'type'],
          severity: DiagnosticSeverity.Error,
          range: expect.any(Object),
        },
      ]);
    ...
    test('validate security schemes', async () => {
      expect(
      ...
      ).toEqual([
        {
          ...
          resolvedPath: ['components', 'securitySchemes', 'basic'],
          severity: DiagnosticSeverity.Error,
          range: expect.any(Object),
        },
      ]);
    ...
    test('validate responses', async () => {
      expect(
      ...
      ).toEqual([
        {
          ...
          resolvedPath: ['paths', '/user', 'get', 'responses', '200'],
          severity: DiagnosticSeverity.Error,
          range: expect.any(Object),
        },
      ]);
