    ...
    expect(results).toEqual([
      {
        ...
        resolvedPath: ['paths', '/foo', 'get', 'parameters', '1'],
      ...
      },
      {
        ...
        resolvedPath: ['paths', '/foo', 'get', 'parameters', '2'],
        range: expect.any(Object),
        severity: DiagnosticSeverity.Warning,
      },
    ]);
  ...
  test('Errors if multiple non-unique param on same operation', async () => {
    ...
    expect(results).toEqual([
      ...
      },
      {
        ...
        resolvedPath: ['paths', '/foo', 'get', 'parameters', '3'],
        range: expect.any(Object),
        severity: DiagnosticSeverity.Warning,
      },
    ]);
  ...
  test('Error if multiple in:body', async () => {
    ...
    expect(results).toEqual([
      ...
      },
      {
        ...
        resolvedPath: ['paths', '/foo', 'put', 'parameters', '3'],
        range: expect.any(Object),
        severity: DiagnosticSeverity.Warning,
      },
      {
        ...
        resolvedPath: ['paths', '/foo', 'put', 'parameters', '5'],
        range: expect.any(Object),
        severity: DiagnosticSeverity.Warning,
      },
    ]);
    ...
    expect(results).toEqual([
      {
        ...
        resolvedPath: ['paths', '/foo', 'get', 'parameters'],
        range: expect.any(Object),
        severity: DiagnosticSeverity.Warning,
      },
    ]);
