      ...
      expect(results).toEqual([
        {
          ...
          resolvedPath: ['definitions', 'Test', 'enum', '1'],
        ...
        },
        {
          ...
          resolvedPath: ['definitions', 'Test', 'enum', '3'],
          range: expect.any(Object),
          severity: DiagnosticSeverity.Warning,
        },
      ]);
      ...
      expect(results).toEqual([
        {
          ...
          resolvedPath: ['components', 'schemas', 'Test', 'enum', '1'],
          range: expect.any(Object),
          severity: DiagnosticSeverity.Warning,
        },
        {
          ...
          resolvedPath: ['components', 'schemas', 'Test', 'enum', '3'],
          range: expect.any(Object),
          severity: DiagnosticSeverity.Warning,
        },
      ]);
