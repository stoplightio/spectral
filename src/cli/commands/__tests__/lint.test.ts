...
const standardOas3RulesetPath = resolve(__dirname, '../../../../dist/rulesets/oas3/oas3.ruleset.yaml');
const standardOas2RulesetPath = resolve(__dirname, '../../../../dist/rulesets/oas2/oas2.ruleset.yaml');
